 ...
 */
export const ObjectUtils_isEqual = <A, B extends A>(a: A, b: B) => isEqual(a, b);
...
export function ObjectUtils_pick<T extends {}, K extends keyof T, U extends Pick<T, K>>(
	obj: T,
	theKeys: K[],
): U {
...
export function ObjectUtils_findMaxValue<T extends Record<string, number | undefined>>(
	obj: T,
): number {
