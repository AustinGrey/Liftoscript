...
function handleLogic(node: SourcedSyntaxNode, tools: EvaluateTools): LogicResult {
	const handler: LogicHandler<NodeNames_Logic> | undefined = isLogicNodeName(node.name)
