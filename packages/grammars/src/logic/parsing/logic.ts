...
export const parser = LRParser.deserialize({
  ...
  termNames: {
    ...
    "22": "StateVariable",
    "23": "StateKeyword",
    "24": "StateVariableIndex",
    "25": "VariableExpression",
    "26": "VariableIndex",
    "27": "Wildcard",
    "28": "IncAssignmentExpression",
    "29": "IncAssignment",
    "30": "BuiltinFunctionExpression",
    "31": "UnaryExpression",
    "32": "Not",
    "33": "expression+",
    "34": '(@specialize[]<Keyword, "else"> @specialize[]<Keyword, "if"> ParenthesisExpression BlockExpression)+',
    "35": '(":" VariableIndex)+',
    "36": '("," expression)+',
    "37": "␄",
    "38": "%mainskip",
