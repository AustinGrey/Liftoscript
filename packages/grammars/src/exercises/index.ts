...
export function getExerciseOrDefault(
	...
	const exercise = maybeGetExercise(type.id, customExercises) ?? allExercisesList.squat;
	return {
		...exercise,
...
export function Exercise_findByNameEquipment(
	...
	const exercise = exerciseId ? maybeGetExercise(exerciseId, customExercises) : undefined;
	if (exercise == null) {
		return undefined;
	}
...
export function Exercise_findByName(
	...
	const exercise = maybeGetExercise(Exercise_findIdByName(name, customExercises), customExercises);
	if (exercise) {
